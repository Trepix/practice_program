...
public class MultipleCommunicationMarsRoverTest {
    ...
    @Test
    public void turns_left_when_pointing_north_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRoverAnywhere().facing("N").build();

        marsRover.receive("kf");

        assertThat(marsRover, is(aMultiInterpreterMarsRoverAnywhere().facing("W").build()));
    }

    @Test
    public void turns_left_when_pointing_west_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRoverAnywhere().facing("W").build();
    ...
    @Test
    public void turns_left_when_pointing_south_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRoverAnywhere().facing("S").build();
    ...
    @Test
    public void turns_left_when_pointing_east_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRoverAnywhere().facing("E").build();
    ...
    @Test
    public void moves_forward_when_pointing_north_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("N").build();

        marsRover.receive("kb");

        assertThat(marsRover, is(aMultiInterpreterMarsRover().at(5, 5).facing("N").build()));
    }

    @Test
    public void moves_forward_when_pointing_east_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("E").build();
    ...
    @Test
    public void moves_forward_when_pointing_south_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("S").build();
    ...
    @Test
    public void moves_forward_when_pointing_west_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("W").build();
    ...
    @Test
    public void moves_backward_when_pointing_north_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("N").build();

        marsRover.receive("kx");

        assertThat(marsRover, is(aMultiInterpreterMarsRover().at(5, 3).facing("N").build()));
    }

    @Test
    public void moves_backward_when_pointing_east_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("E").build();
    ...
    @Test
    public void moves_backward_when_pointing_south_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("S").build();
    ...
    @Test
    public void moves_backward_when_pointing_west_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(5, 4).facing("W").build();
    ...
    @Test
    public void receives_multiple_commands_using_esa_commands() {
        MarsRover marsRover = aMultiInterpreterMarsRover().at(7, 4).facing("E").build();

        marsRover.receive("kbl");
