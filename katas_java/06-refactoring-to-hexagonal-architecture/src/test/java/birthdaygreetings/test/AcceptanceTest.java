...
public class AcceptanceTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new BirthdayService(new CsvFileEmployeeRepository("src/test/resources/employee_data.txt")) {
            @Override
    ...
    public void baseScenario() throws Exception {
        ...
        service.sendGreetings(
                OurDateFactory.createFromDateSeparatedBySlash("2008/10/08"), "localhost", SMTP_PORT);
    ...
    public void willNotSendEmailsWhenNobodysBirthday() throws Exception {
        service.sendGreetings(
                OurDateFactory.createFromDateSeparatedBySlash("2008/01/01"), "localhost", SMTP_PORT);
